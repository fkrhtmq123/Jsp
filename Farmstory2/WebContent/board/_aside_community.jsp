    ...
    <section>
        <aside>
            ...
            <ul>
                ...
                <li class="<%= (cate.equals("qna")) ? "on":"" %>"><a href="./list.jsp?group=community&cate=qna">1:1고객문의</a></li>
                <li class="<%= (cate.equals("faq")) ? "on":"" %>"><a href="./list.jsp?group=community&cate=faq">자주묻는질문</a></li>
            </ul>
        </aside>
        <article>
            <nav>
                <img src="/Farmstory2/img/sub_nav_tit_cate5_tit_<%= cate %>.png" alt="공지사항">
                <p>
                    <img src="/Farmstory2/img/sub_page_nav_ico.gif" alt="">
                    HOME > 커뮤니티 > 
