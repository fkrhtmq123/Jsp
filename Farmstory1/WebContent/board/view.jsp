...
<%
	...
	if(mb == null) {
		response.sendRedirect("/Farmstory1/list.jsp?group="+group+"&cate"+cate);
		return;
	}
...
<section id="board" class="view">
    ...
    <table>
        ...
        <tr>
            <td>첨부파일</td>
            <td>
                <a href="/Farmstory1/board/proc/download.jsp?seq=<%= fBean.getSeq() %>"><%= fileBean.getOldName() %></a>
    ...
    <section class="commentList">
        ...
        <article class="comment">
            ...
            <div>
            	...
            	%>
                <a href="/Farmstory1/board/proc/deleteComment.jsp?seq=<%= comment.getSeq() %>&parent=<%= article.getSeq() %>&group=<%= group %>&cate=<%= cate %>">삭제</a>
                <a href="#">수정</a>
                <% } %>
            </div>
        </article>
